...
import Reviews, { type reviewWithUser } from "./TourDetails/Reviews/Reviews";
import useGetData from "../../../../hooks/useGetData";
import { SINGLE_TOUR_KEY } from "../../../../constants/react-query";
import { getSingleTours } from "../../../../api-call/tour-api";
      ...
      <section className="bg-darkBlue w-full">
        ...
        <div className="roundedBg pb-[4rem]">
          <Screen>
            ...
            <div
              id="map"
              className="bg-white shadow-sm p-5 rounded-xl mt-[1rem]"
            >
            ...
            <Reviews
              title={singleTour?.title as string}
              tourId={singleTour?.id as string}
              reviews={singleTour?.reviews as reviewWithUser[]}
            />
          </Screen>
        </div>
      </section>
