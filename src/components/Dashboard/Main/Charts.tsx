...
const Revenue = () => {
  return (
    <div className="flex-[1.2] border border-gray-200 rounded-md p-3 ">
...
const DistinatoinBox = ({ title, participents }) => {
  const color = "";
  return (
    <div className="flex gap-2">
      <p className={`size-3 bg-blue-400 rounded-sm mt-2`} />
      <div>
...
const TopDistinations = () => {
  return (
    <section className="flex-1 border border-gray-200 rounded-md p-3">
      <div className="flex items-center justify-between">
